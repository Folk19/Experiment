...
namespace CRFSharp
{
    ...
    public class DecoderTagger : Tagger
    {
        ...
        int nbest_; //output top N-best result
        //CrfModel model;
        ...
        Heap heap_queue; //Using min-heap to get next result
        int tag_init_stat; //tag初始化状态位

        public static uint crf_max_word_num;

        public DecoderTagger(uint this_crf_max_word_num = Utils.DEFAULT_CRF_MAX_WORD_NUM)
        {
        ...
        //Get the number of NBest
        public int get_nbest()
        {
            return nbest_;
        }
        ...
        //设置nbest
        public void set_nbest(int nbest)
        {
            nbest_ = nbest;
        }
        ...
        public int next()
        {
            ...
            {
                return Utils.ERROR_WRONG_STATUS;
            }
